...
export default function Listing() {
  ...
  return (
    <main>
      ...
      {error && (
        <p className="text-center my-7 text-2xl">Something isn't right!!</p> //// if error is true, show error message
      )}
      {listing &&
        !loading &&
        !error && ( // if listing is not null and loading and error are false
          <>
            <Swiper navigation>
